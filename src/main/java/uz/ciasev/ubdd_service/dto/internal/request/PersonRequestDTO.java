...
public class PersonRequestDTO {
    ...
    @Size(max = 100, message = ErrorCode.MAX_FIRST_NAME_KIR_LENGTH)
    @NotBlank(message = ErrorCode.FIRST_NAME_KIR_REQUIRED)
    private String firstNameKir;

    @Size(max = 100, message = ErrorCode.MAX_SECOND_NAME_KIR_LENGTH)
    private String secondNameKir;

    @Size(max = 100, message = ErrorCode.MAX_LAST_NAME_KIR_LENGTH)
    @NotBlank(message = ErrorCode.LAST_NAME_KIR_REQUIRED)
    private String lastNameKir;

    @Size(max = 100, message = ErrorCode.MAX_FIRST_NAME_LAT_LENGTH)
    @NotBlank(message = ErrorCode.FIRST_NAME_LAT_REQUIRED)
    private String firstNameLat;

    @Size(max = 100, message = ErrorCode.MAX_SECOND_NAME_LAT_LENGTH)
    private String secondNameLat;

    @Size(max = 100, message = ErrorCode.MAX_LAST_NAME_LAT_LENGTH)
